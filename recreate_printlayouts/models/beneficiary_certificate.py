...
class BeneficiaryCertificateXlsx(models.AbstractModel):
    ...
    def generate_xlsx_report(self, workbook, data, picking):
        for obj in picking:
            ...
            sheet.write("C26", "P/I No.:", main_content_label_format)
            sheet.write("C28", "Name of Vessel:", main_content_label_format)
            sheet.write("C30", "Voyage Number:", main_content_label_format)
            sheet.write("C32", "Shipment Date", main_content_label_format)
            sheet.write("C34", "Bill of Lading Number:", main_content_label_format)
            ...
            sheet.write("B46", "ISSUE BY", header_format)
